...
x_train = d2_train_dataset[0:20000]
y_train = train_labels[0:20000] 
...
# Support Vector Machine model with custom cosine kernel and one-vs-rest stategic (ovr)
# it is the same with the one-vs-all
model = svm.SVC(kernel = cosine_kernel, decision_function_shape = 'ovr')
